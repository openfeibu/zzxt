...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal adminform" name="admin_list_edit" method="post" action="<?php echo url('admin/Admin/admin_runedit'); ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="admin_faculty" id="">
								<option value=""></option>
								<?php foreach($admin_faculty as $row): ?>
								<option value="<?php echo $row['faculty_number']; ?>"<?php if($admin_list['admin_faculty'] == $row['faculty_number']): ?>selected<?php endif; ?>><?php echo $row['faculty_name']; ?></option>
								<?php endforeach; ?>
							</select>
