        ...
        <div class="col-md-12 column">
            <div class="w1000">
                <div class="personal_num">
                    <div class="passed">
                        <p class="success_bg"><span></span><span>所有专业</span><span>已评定人数：</span></p>
                        <p class="default_bg"><span>10</span>人</p>
                    </div>
                    <div class="passed pull-right">
                        <p class="danger_bg"><span></span><span>所有专业</span><span>未评定人数：</span></p>
                ...
                <form class="tab_inquire" method="post">
                    <p>筛选：</p>
                    <select class="form-control tab_select faculty_grade">
                        <option value=""></option>
                        <option value="">2015级</option>
                        <option value="">2016级</option>
                        <option value="">2017级</option>
                    </select>
                    <select class="form-control tab_select faculty_sub">
                    ...
                    <select class="form-control tab_select faculty_pass">
                        <option value="0">专业评定</option>
                        <option value="1">班级已评定</option>
                        <option value="1">班级未评定</option>
                        <option value="2">院系已评定</option>
                        <option value="2">院系未评定</option>
                    </select>
                    ...
                    <tr>
                        ...
                        <td class="tab_content">
                            <div class="audit_opera">
                                <a href="<?php echo url('admin/EvaluFront/E_faculty_add_review'); ?>" class="btn btn-info btn-sm">通过</a>
                            </div>
                            <div class="audit_opera">
                                <a href="<?php echo url('admin/EvaluFront/E_faculty_add_review'); ?>" class="btn btn-info btn-sm">不通过</a>
                            </div>
                            <div class="audit_opera">
