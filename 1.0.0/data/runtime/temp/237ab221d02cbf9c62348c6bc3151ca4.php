            ...
            <div class="w1000">
                ...
                <table  id="simple-table"  class="table table-striped table-bordered table-hover tab_center">
                    ...
                    <tr>
                        ...
                        <form action="<?php echo url('admin/Counselor/evaluationPassing'); ?>" method="post">
