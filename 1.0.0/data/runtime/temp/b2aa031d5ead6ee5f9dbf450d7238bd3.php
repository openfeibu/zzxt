            ...
            <form class="w900" method="post">
                <table class="table_heading" style="width:100%">
                    ...
                    <tr>
                        <td colspan="2" style="padding: 10px">
                            年级班级（专业）<input type="text" class="input_border_bottom" value="15物联网应用技术一班" disabled>
                        </td>
                        <td colspan="1">
                    ...
                    <tr>
                        <td style="padding: 5px">
                            院（系）<input type="text" class="input_border_bottom" value="机电系" disabled>
                        </td>
                        <td style="padding: 5px">
                            宿舍<input type="text" class="input_border_bottom" value="21#517" disabled>
                        </td>
                        <td style="padding: 5px">
                            学号<input type="text" class="input_border_bottom" value="20153328110" disabled>
                        </td>
                    </tr>
                </table>
                <table class="table table-bordered tab_center">
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="tab_content">韦发炫</td>
                        <td class="tab_title">性别</td>
                        <td class="tab_content">男</td>
                        <td class="tab_title">民族</td>
                        <td class="tab_content">汉族</td>
                        <td class="tab_title">出生年月</td>
                        <td colspan="2" class="tab_content tab_140px">1997-11-28</td>
                    </tr>
                    <tr>
                        <td class="tab_title">身份证</td>
                        <td colspan="3" class="tab_content">440521199711287687</td>
                        <td colspan="4" class="tab_title">户口（转入学校户口的学生填写入学前户口）</td>
                        <td colspan="2" class="tab_content">
                            <div style="display:inline-block;">
                                <label>
                                    <input type="radio" name="" style="height:auto;width: auto;margin-right: 5px;" disabled/>城镇
                                </label>
                            </div>
                            <div style="display:inline-block;">
                                <label>
                                    <input type="radio" name="" style="height:auto;width: auto;margin-right: 5px;" checked disabled/>农村
                                </label>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="11" class="tab_content">
                            ...
                            <textarea name="" id="" class="tab_opinion" disabled>黑科技阿萨达是发给你们这些破情人坡马老师的可能发挥科技</textarea>
                            <div class="tab_sign">
                                <label for="">组长签名：</label>
                                <input type="text" value="吕海强" disabled>
                            </div>
                            <div class="clearfix"></div>
                            <div class="tab_time">
                                <input type="text" value="2017" disabled>年
                                <input type="text" value="11" disabled>月
                                <input type="text" value="1" disabled>日
                            </div>
                        </td>
                    </tr>
                    <!--院系小组评语-->
                ...
                <table class="w800">
                    <tr>
                        <td class="tab_title"><p class=" tab_left" style="font-size: 16px;">学生处添加评语：</p></td>
                        <td colspan="2"></td>
                    </tr>
                    <tr>
                        <td colspan="3" class="tab_content">
                            <textarea name="" id="" class="tab_opinion"></textarea>
                    ...
                    <tr>
                        ...
                        <td class="tab_content" style="width: 266px;">
                            <a href="<?php echo url('admin/EvaluFront/E_manage_check_proof'); ?>" class="btn btn-info">查看相关证明</a>
