<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\UPUPW_K2.1\htdocs\zzxt/app/home/view/default/\home_page\index_front.html";i:1504001484;s:83:"D:\UPUPW_K2.1\htdocs\zzxt/app/home/view/default/public\header\nav_guest_header.html";i:1504001484;s:66:"D:\UPUPW_K2.1\htdocs\zzxt/app/home/view/default/public\footer.html";i:1504001484;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="nav-old">
    <ul class="w1000">
        <li class="active"><a href="<?php echo url('/index_front'); ?>">首页</a></li>
...
<nav class="w1000 ">
    <ul class="nav nav-tabs">
        ...
        <li  role="presentation" class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" >经济困难认定<span class="caret"></span></a>
        ...
        <li  role="presentation" class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" >国家三金申请<span class="caret"></span></a>
            <ul class="dropdown-menu">
                <li><a href="">国家助学金</a></li>
                <li><a href="">国家励志奖学金</a></li>
                <li><a href="">国家奖学金</a></li>
            </ul>
        </li>
        <li  role="presentation" class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" >勤工助学<span class="caret"></span></a>
            <ul class="dropdown-menu">
                <li><a href="">个人简历</a></li>
                <li><a href="">岗位申报</a></li>
            </ul>
        </li>
        <li  role="presentation"><a href="">调查问卷</a></li>
        <li  role="presentation"><a href="">审核状态</a></li>
        <li role="presentation"><a href="">通知公示</a></li>
        <li role="presentation" class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" >评估公示<span class="caret"></span></a>
            <ul class="dropdown-menu">
...
<div class="main w1000">
    ...
    <div class="login">
        ...
        <div class="personal_link">
            <a class="btn personal_btn" href="<?php echo url('/questionnaire'); ?>">个人中心</a>
    ...
    <div class="banner">
        <ul>
            ...
            <li>
                <a href="">
                    <img src="<?php echo $yf_theme_path; ?>public/images/logo.png" alt="">
                    <span>标题2</span>
                </a>
            </li>
            <li>
    ...
    <div class="fb-portlet">
        <div class="fb-portlet-title">
            <span>资助新闻</span>
            <a href="<?php echo url('/news'); ?>" class="fb-portlet-more fb-transition">更多</a>
        </div>
        <ul>
    ...
    <div class="fb-portlet">
        <div class="fb-portlet-title">
            <span>资助政策</span>
            <a href="<?php echo url('/policy'); ?>" class="fb-portlet-more fb-transition">更多</a>
        </div>
        <ul>
    ...
    <div class="fb-portlet" style="margin-left: 15px;">
        <div class="fb-portlet-title">
            <span>通知公告</span>
            <a href="<?php echo url('/notice'); ?>" class="fb-portlet-more fb-transition">更多</a>
        </div>
        <ul>
    ...
    <div class="fb-seamless">
        ...
        <div class="fb-seamless-con">
            <ul>
                <li><img src="<?php echo $yf_theme_path; ?>public/images/1.jpg" alt=""></li>
