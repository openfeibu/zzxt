                ...
                <table  id="simple-table"  class="table table-striped table-bordered table-hover tab_center">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php elseif($row['status']==2): ?>辅导员通过
                            <?php elseif($row['status']==3): ?>班级小组通过
                            <?php elseif($row['status']==4): ?>院系小组通过
                            <?php elseif($row['status']==5): ?>学生处通过
                            <?php elseif($row['status']==6): ?>辅导员不通过
                            <?php elseif($row['status']==7): ?>班级小组不通过
                            <?php elseif($row['status']==8): ?>院系小组不通过
                            <?php elseif($row['status']==9): ?>学生处不通过
                            <?php endif; ?>
                        </td>
                        <form action="<?php echo url('admin/StudentOffice/fillEvaluationOpinion'); ?>" method="post">
                            <td class="tab_content">
                                ...
                                <div class="audit_opera">
                                    <button class="btn btn-info btn-sm btn-success" name="pass">通过</button>
                                </div>
                                <div class="audit_opera">
                                    <button class="btn btn-info btn-sm btn-danger" name="fail" value="1">不通过</button>
                                </div>

                                <div class="audit_opera">
                                    <a href="<?php echo url('admin/StudentOffice/showEvaluationMaterial',['id'=>$row['status_id']]); ?>" class="btn btn-info btn-sm">查看</a>
                                </div>
                            </td>
                        </form>
                    </tr>
