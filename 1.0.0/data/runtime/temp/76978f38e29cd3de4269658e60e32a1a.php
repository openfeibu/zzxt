                ...
                <table class="table table-striped table-bordered table-hover" id="dynamic-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="submit" class="btn  btn-sm btn-success" value="修改" tid="<?php echo $v['id']; ?>" onclick="changeTime($(this))"></td>
                        </tr>
