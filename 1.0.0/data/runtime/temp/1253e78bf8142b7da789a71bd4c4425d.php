    ...
    <div class="page-header">
        <h1>
            ...
            <small>
                ...
                <a href="<?php echo url('admin/EvaluFront/E_counselor_review'); ?>">学生家庭经济困难认定</a>
            </small>
            <small>
...
<table class="table table-bordered tab_center">
    ...
    <tr>
        ...
        <td colspan="2" class="tab_content">
            <div style="display:inline-block;">
                <label>
                    <input type="radio" name=""  disabled <?php if($user['is_rural_student']=='否'): ?> checked <?php endif; ?>/>城镇
                </label>
            </div>
            <div style="display:inline-block;">
                <label>
                    <input type="radio" name=""  disabled <?php if($user['is_rural_student']=='是'): ?> checked <?php endif; ?>/>农村
                </label>
            </div>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="2" class="tab_content"><?php echo $eval_app['population']; ?></td>
        <td colspan="3" class="tab_title">家庭成员在学人数</td>
        <td colspan="2" class="tab_content"><?php echo $eval_app['school_population']; ?></td>
    </tr>
    <tr>
        <td colspan="9" class="tab_radio">
            <div class="radio_block">
                ...
                <label class="input_radio">
                     <input type="radio" name="establish_card" value="1" <?php if($eval_app['establish_card'] == 1): ?>checked<?php endif; ?>/>是
                </label>
                <label class="input_radio">
                    <input type="radio" name="establish_card"  value="0" <?php if($eval_app['establish_card'] == 0): ?>checked<?php endif; ?>/>否
                </label>
            </div>
            ...
            <div class="radio_block">
                <p>2.特困供养人员</p>
                <label class="input_radio">
                    <input type="radio" name="special_person"  value="1" <?php if($eval_app['special_person'] == 1): ?>checked<?php endif; ?>/>是
                </label>
                <label class="input_radio">
                    <input type="radio" name="special_person"  value="0" <?php if($eval_app['special_person'] == 0): ?>checked<?php endif; ?>/>否
                </label>
            </div>
            ...
            <div class="radio_block">
                <p>3.城乡最低生活保障户</p>
                <label class="input_radio">
                    <input type="radio" name="mini_living"  value="1" <?php if($eval_app['mini_living'] == 1): ?>checked<?php endif; ?>/>是
                </label>
                <label class="input_radio">
                     <input type="radio" name="mini_living"  value="0" <?php if($eval_app['mini_living'] == 0): ?>checked<?php endif; ?>/>否
                </label>
            </div>
        </td>
    </tr>
    <tr>
        <td colspan="9" class="tab_radio">
            <div class="radio_block">
                <p>4.特困职工子女</p>
                <label class="input_radio">
                    <input type="radio" name="poor_children"  value="1" <?php if($eval_app['poor_children'] == 1): ?>checked<?php endif; ?>/>是
                </label>
                <label class="input_radio">
                    <input type="radio" name="poor_children"  value="0" <?php if($eval_app['poor_children'] == 0): ?>checked<?php endif; ?>/>否
                </label>
            </div>
            ...
            <div class="radio_block">
                <p>5.城镇低收入困难家庭</p>
                <label class="input_radio">
                    <input type="radio" name="low_income"  value="1" <?php if($eval_app['low_income'] == 1): ?>checked<?php endif; ?>/>是
                </label>
                <label class="input_radio">
                     <input type="radio" name="low_income"  value="0" <?php if($eval_app['low_income'] == 0): ?>checked<?php endif; ?>/>否
                </label>
            </div>
            ...
            <div class="radio_block">
                <p>6.孤儿</p>
                <label class="input_radio">
                    <input type="radio" name="orphan" value="1" value="1" <?php if($eval_app['orphan'] == 1): ?>checked<?php endif; ?>/>是
                </label>
                <label class="input_radio">
                    <input type="radio" name="orphan" value="1" value="1" <?php if($eval_app['orphan'] == 1): ?>checked<?php endif; ?>/>是
                </label>
    ...
    <tr>
        <td colspan="9" class="tab_radio">
            <div class="radio_block">
                <p>7.父母一方抚养</p>
                <label class="input_radio">
                     <input type="radio" name="single_parent" value="1" <?php if($eval_app['single_parent'] == 1): ?>checked<?php endif; ?>/>是
                </label>
                <label class="input_radio">
                     <input type="radio" name="single_parent" value="0" <?php if($eval_app['single_parent'] == 0): ?>checked<?php endif; ?>/>否
                </label>
            </div>
            ...
            <div class="radio_block">
                ...
                <label class="input_radio">
                    <input type="radio" name="martyrs_children" value="1" <?php if($eval_app['martyrs_children'] == 1): ?>checked<?php endif; ?>/>是
                </label>
                <label class="input_radio">
                    <input type="radio" name="martyrs_children" value="0" <?php if($eval_app['martyrs_children'] == 0): ?>checked<?php endif; ?>/>否
                </label>
            </div>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="9" class="tab_radio">
            <div class="radio_block">
                <p>1.残疾</p>
                <label class="input_radio">
                    <input type="radio" name="disability" value="1" <?php if($eval_app['disability'] == 1): ?>checked<?php endif; ?>/>是
                </label>
                <label class="input_radio">
                    <input type="radio" name="disability" value="0" <?php if($eval_app['disability'] == 0): ?>checked<?php endif; ?>/>否
                </label>
            </div>
            ...
            <div class="radio_block">
                <p>2.患重大疾病</p>
                <label class="input_radio">
                    <input type="radio" name="suffering" value="1" <?php if($eval_app['suffering'] == 1): ?>checked<?php endif; ?>/>是
                </label>
                <label class="input_radio">
                    <input type="radio" name="suffering" value="0" <?php if($eval_app['suffering'] == 0): ?>checked<?php endif; ?>/>否
                </label>
            </div>
        </td>
    </tr>
    <tr>
        <td colspan="9" class="tab_radio">
            <div class="radio_block">
				...
				<label class="input_radio">
					<input type="radio" name="disability_type" value="<?php echo $key; ?>" <?php if($key == $eval_app['disability_type']): ?>checked<?php endif; ?>/><?php echo $val; ?>
				</label>
				<?php endforeach; ?>
                <input type="text" class="input_border_bottom"  name="disability_type_other"  value="<?php echo $eval_app['disability_type_other']; ?>" disabled>
            </div>
            ...
            <div class="radio_block">
                ...
                <label class="input_radio">
                    <input type="radio"  name="disability_grade" value="<?php echo $key; ?>" <?php if($key == $eval_app['disability_grade']): ?>checked<?php endif; ?>/><?php echo $val; ?>
                </label>
				<?php endforeach; ?>
            </div>
        </td>
    ...
    <tr>
        ...
        <td colspan=2 class="tab_content"><?php echo $eval_app['zip_code']; ?></td>
        <td class="tab_title">联系电话</td>
        <td colspan="2" class="tab_content"><?php echo $eval_app['number']; ?></td>
        <td colspan="2" class="tab_title">家庭人均年收入</td>
        <td colspan="2" class="tab_content"><?php echo $eval_app['annual_income']; ?></td>
    </tr>
    <tr>
        ...
        <td colspan="4" class="tab_radio">
            <div class="radio_block">
				...
				<label class="input_radio">
                    <input type="radio" name="housing_situation" value="<?php echo $key; ?>" <?php if($key == $eval_app['housing_situation']): ?>checked<?php endif; ?>/><?php echo $val; ?>
                </label>
				<?php endforeach; ?>
                <input type="text" class="input_border_bottom" name="housing_situation_other" value="<?php echo $eval_app['housing_situation_other']; ?>" disabled />
            </div>
        </td>
        ...
        <td colspan="4" class="tab_radio">
            <div class="radio_block">
				...
				<label class="input_radio">
                    <input type="radio"  name="car_situation" value="<?php echo $key; ?>" <?php if($key == $eval_app['car_situation']): ?>checked<?php endif; ?>/><?php echo $val; ?>
                </label>
				<?php endforeach; ?>
	...
	<?php $__FOR_START_7866__=1;$__FOR_END_7866__=8;for($i=$__FOR_START_7866__;$i < $__FOR_END_7866__;$i+=1){ if($eval_app['members']['name'][$i-1]): ?>
		 <tr class="line-table-height">
			<td class="tab_content"><?php echo $eval_app['members']['name'][$i-1]; ?></td>
			<td class="tab_content"><?php echo $eval_app['members']['age'][$i-1]; ?></td>
			<td class="tab_content">
				<?php echo $eval_form['relationship'][$eval_app['members']['relationship'][$i-1]]; ?>
			</td>
			<td class="tab_content" colspan="2"><?php echo $eval_app['members']['unit'][$i-1]; ?></td>
			<td class="tab_content"><?php echo $eval_app['members']['number'][$i-1]; ?></td>
			<td class="tab_content">
			...
			<td class="tab_content"><?php echo $eval_app['members']['income'][$i-1]; ?></td>
			<td class="tab_content">              
    ...
    <tr>
        ...
        <td colspan="10" class="tab_title" style="text-align: left!important;">
            <div>
                ...
                <input class="input_border_bottom" style="width: 60%!important;" type="text" value="<?php echo $eval_app['income_source']; ?>" disabled>
            </div>
            <p>
                （只能选填其中一项。<br>
            ...
            <div>
                ...
                <input class="input_border_bottom" style="width: 60%!important;" type="text" value="<?php echo $eval_app['funded']; ?>" disabled>
            </div>
            ...
            <div>
                ...
                <input class="input_border_bottom" style="width: 60%!important;" type="text" value="<?php echo $eval_app['natural_disasters']; ?>" disabled>
            </div>
            <div>
                ...
                <input class="input_border_bottom" style="width: 60%!important;" type="text" value="<?php echo $eval_app['unexpected_events']; ?>" disabled>
            </div>
            <div>
                <label for="">家庭欠债情况：</label>
                <input class="input_border_bottom" style="width: 60%!important;" type="text" value="<?php echo $eval_app['debt']; ?>" disabled>
            </div>
            <div>
                <label for="">其他情况：</label>
                <input class="input_border_bottom" style="width: 60%!important;" type="text" value="<?php echo $eval_app['other']; ?>" disabled>
            </div>
        </td>
    </tr>
</table>             
