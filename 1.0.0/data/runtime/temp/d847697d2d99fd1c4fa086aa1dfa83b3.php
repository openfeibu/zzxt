                ...
                <form id="leftnav" name="leftnav" method="post" action="" >
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dynamic-table">
                        ...
                        <tr>
                            ...
                            <th style="border-right:#CCC solid 1px;">提交</th>
                        </tr>
                        </thead>
                        ...
                        <tr>
                            ...
                            <td class="hidden-sm hidden-xs"><input type="text" value="<?php echo date('Y-m-d',$v['begin_time']); ?>" name="begin_time" data-provide="datepicker"></td>
                            <td class="hidden-sm hidden-xs"><input type="text" value="<?php echo date('Y-m-d',$v['end_time']); ?>" name="end_time" data-provide="datepicker"></td>
                            <td><input type="button" class="btn  btn-sm btn-success" value="修改" tid="<?php echo $v['id']; ?>" onclick="changeTime($(this))"></td>
                        </tr>
...
//        console.log(begin_time)
        $.post("<?php echo url('/admin/set_subsidy/index'); ?>", {id:id,begin_time:begin_time,end_time:end_time},function(data){
                location.reload()
        })
    }
