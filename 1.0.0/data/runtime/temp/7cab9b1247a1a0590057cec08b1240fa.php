...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal memberform" name="member_list_add" method="post" action="<?php echo url('admin/Member/member_runadd'); ?>">
						...
						<div class="col-sm-10">
							<select name="member_list_groupid"  class="col-sm-4 selector" required>
								...
								<?php if(is_array($member_group) || $member_group instanceof \think\Collection || $member_group instanceof \think\Paginator): if( count($member_group)==0 ) : echo "" ;else: foreach($member_group as $key=>$v): ?>
									<option value="<?php echo $v['member_group_id']; ?>"><?php echo $v['member_group_name']; ?></option>
