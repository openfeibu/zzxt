<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"D:\UPUPW_K2.1\htdocs\zzxt/app/home/view/default/\student_notice\grants_notice.html";i:1503813473;s:79:"D:\UPUPW_K2.1\htdocs\zzxt/app/home/view/default/public\header\index_header.html";i:1503929655;s:81:"D:\UPUPW_K2.1\htdocs\zzxt/app/home/view/default/student_notice\notice_header.html";i:1503813473;s:66:"D:\UPUPW_K2.1\htdocs\zzxt/app/home/view/default/public\footer.html";i:1503885760;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="main w1000">
    ...
    <form action="" method="post">
        <div class="notice_select">
            <button class="btn btn-sm" style="margin-bottom: 12px;" name="department" value="1">查看本系</button>
            <button class="btn btn-sm" style="margin-bottom: 12px;" name="school" value="1">查看全院</button>
        </div>
    ...
    <table width="756px" class="k-w-table line_table" style="margin: 10px auto 20px auto;">
        ...
        <tr class="line-table-height">
            ...
            <td class="k-s-content content"><?php echo $row['user_id']; ?></td>
            <td class="k-s-content content"><?php echo $row['profession']; ?><?php echo $row['class']; ?></td>
            <td class="k-s-content content"></td>
            <td class="k-s-content content"></td>
        </tr>
        <?php endforeach; ?>
        </tbody>
