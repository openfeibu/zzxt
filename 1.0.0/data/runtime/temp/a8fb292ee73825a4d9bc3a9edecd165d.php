...
<div class="page-content">
    <div class="page-header">
        <h1>
            您当前操作
            <small>
                <i class="ace-icon fa fa-angle-double-right"></i>国家助学金班级审核
            </small>
            <!--<small>-->
        ...
        <div class="col-md-12 column">
            <div>
                <div class="personal_num">
                    <div class="passed">
                        <p class="success_bg">班级评定通过人数：</p>
                        <p class="default_bg"><span><?php echo $yes_count; ?></span>人</p>
                    </div>
                    <div class="passed pull-right">
                        <p class="danger_bg">班级未评定通过人数：</p>
                        <p class="default_bg"><span><?php echo $no_count; ?></span>人</p>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <form class="tab_inquire" method="post">
                    <p>筛选：</p>
                    <select class="form-control tab_select class_select" name="assess">
                        <option value="0">全班评定</option>
                        <option value="1">班级已评定</option>
                        <option value="2">班级未评定</option>
                        <!--<option value="3">院系已评定</option>-->
                        <!--<option value="4">院系未评定</option>-->
                    </select>
                ...
                <!--<table class="table table-striped table-bordered table-hover tab_center">
                    ...
                    <tr>
                        <td class="tab_content"><?php echo $row['status_id']; ?></td>
                        <td class="tab_content"><?php echo $row['studentname']; ?></td>
                        <td class="tab_content"><?php echo $row['user_id']; ?></td>
                        <td class="tab_content"><?php echo $row['department_name']; ?><?php echo $row['profession']; ?><?php echo $row['class']; ?></td>
                        ...
                        <td class="tab_content">
                            <div class="audit_opera">
                                <a href="<?php echo url('admin/ScholarshipsGroup/showMaterial',['id'=>$row['status_id'],'type_id'=>$id]); ?>" class="btn btn-info btn-sm">添加评语</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                ...
                <div class="notice_page" style="margin: 40px 0 0  0">
