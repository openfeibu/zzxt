...
<div class="page-content">
    <div class="page-header">
        <h1>
            您当前操作
            <small>
                <i class="ace-icon fa fa-angle-double-right"></i>国家奖学金班级审核
            </small>
            <!--<small>-->
        ...
        <div class="col-md-12 column">
            <div >
                <!--<table class="table table-striped table-bordered table-hover tab_center">
                    ...
                    <tbody>
                    <?php if(is_array($user) || $user instanceof \think\Collection || $user instanceof \think\Paginator): if( count($user)==0 ) : echo "" ;else: foreach($user as $k=>$vo): ?>
                    <tr>
                        <td class="tab_content"><?php echo $k+1; ?></td>

                        <td class="tab_content"><?php echo $vo['user_name']['studentname']; ?></td>

                        <td class="tab_content"><?php echo $vo['user_id']; ?></td>
                        <td class="tab_content">
                            <?php if($vo['status'] == 1): ?>申请书已经提交
                            <?php elseif($vo['status'] == 2): ?>辅导员通过
                            <?php elseif($vo['status'] == 3): ?>院系小组通过
                            <?php elseif($vo['status'] == 4): ?>学生处通过
                            <?php elseif($vo['status'] == 5): ?>辅导员不通过
                            <?php elseif($vo['status'] == 6): ?>院系小组不通过
                            <?php elseif($vo['status'] == 7): ?>学生处不通过
                            <?php endif; ?>
                        </td>
                        <td class="tab_content">
                            <div class="audit_opera">
                                &lt;!&ndash;<a href="<?php echo url('admin/Counselor/showMaterial',['id' => $vo['status_id']]); ?>" class="btn btn-info btn-sm">添加评语</a>&ndash;&gt;
                            </div>
                        </td>
                    </tr>
                ...
                <table class="table table-striped table-bordered table-hover tab_center">
                    ...
                    <tr>
                        ...
                        <td><?php echo $vo['user_name']['studentname']; ?></td>
