...
<div class="page-content">
    <div class="page-header">
        <h1>
            您当前操作
            <small>
                <i class="ace-icon fa fa-angle-double-right"></i>学生家庭经济困难认定评分标准
            </small>
        </h1>
    </div>
        ...
        <div class="col-md-12 column">
                <div class="col-xs-12">
                    <table  id="simple-table"  class="table table-striped table-bordered table-hover tab_center">
                        ...
                        <tbody>
                        <?php foreach($material_configs as $key => $val): ?>
                        <tr>
                            <td><?php echo $val['cid']; ?></td>
                            <td><?php echo $val['name']; ?></td>
                            <td><?php echo $val['desc']; ?></td>
                            <td><?php echo $val['remark']; ?></td>
                            <td data-id="<?php echo $val['cid']; ?>">
                                <input name="score" attr="" value="<?php echo $val['score']; ?>" class="score score_input">
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        </tbody>
