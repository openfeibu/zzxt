<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/\evaluation\evalu_status.html";i:1504198734;s:94:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/public\header\nav_membership_header.html";i:1524040310;s:72:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/public\footer.html";i:1515387963;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="myexam">
        <table width="800" style="margin:0 auto;border-radio:5px;">
            <tr class="line-table-height"style="font-size: 16px;" >
                <td class="k-s-content"  width="40%">家庭经济困难认定状态</td>
                <td class="k-s-content" >
                    <span class="review-success">已通过！</span>
                </td>
            </tr>
            <tr class="line-table-height"style="font-size: 16px;" >
                <td class="k-s-content"  width="40%">国家助学金审核状态</td>
                <td class="k-s-content" >
                    <span class="review-success">已通过！</span>
                </td>
            </tr>
            <tr class="line-table-height"style="font-size: 16px;" >
                <td class="k-s-content"  width="40%">国家励志奖学金审核状态</td>
                <td class="k-s-content" >
                    <span class="review-success">已通过！</span>
                </td>
            </tr>
            <tr class="line-table-height"style="font-size: 16px;" >
                <td class="k-s-content"  width="40%">国家奖学金审核状态</td>
                <td class="k-s-content" >
                    <span class="review-success">已通过！</span>
                </td>
            </tr>
            <tr class="line-table-height"style="font-size: 16px;" >
                <td class="k-s-content"  width="40%">勤工助学录用状态</td>
                <td class="k-s-content" >
                    <span class="review-success">已通过！</span>
                </td>
            </tr>
