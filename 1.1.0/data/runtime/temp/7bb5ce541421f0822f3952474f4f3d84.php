	...
	<div class="page-content">
		...
		<div class="row maintop">
			<div class="col-xs-4 col-sm-2 margintop5">
				<a href="<?php echo url('admin/Admin/faculty_admin_add'); ?>">
			...
			<div class="col-xs-10 col-sm-5 margintop5">
				<form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('admin/Admin/faculty_admin_list'); ?>">
			...
			<div class="col-xs-4 col-sm-5 margintop5">
				<div class="input-group-btn">
					<a href="<?php echo url('admin/Admin/faculty_admin_list'); ?>">
								...
								<tr>
									...
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a class="green" href="<?php echo url('admin/Admin/faculty_admin_edit',array('admin_id'=>$v['admin_id'])); ?>" title="修改">
												<i class="ace-icon fa fa-pencil bigger-130"></i>																</a>
											<?php if($v['admin_id'] != 1): ?>
												<a class="red confirm-rst-url-btn" data-info="你确定要删除吗？" href="<?php echo url('admin/Admin/admin_counselor_del',array('admin_id'=>$v['admin_id'])); ?>" title="删除">
										...
										<div class="hidden-md hidden-lg">
											<div class="inline position-relative">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													<li>
														<a href="<?php echo url('admin/Admin/faculty_admin_edit',array('admin_id'=>$v['admin_id'])); ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
																	<span class="green">
													...
													<?php if($v['admin_id'] != 1): ?>
														<li>
															<a href="<?php echo url('admin/Admin/admin_counselor_del',array('admin_id'=>$v['admin_id'])); ?>"  data-info="你确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-original-title="删除">
																	<span class="red">
