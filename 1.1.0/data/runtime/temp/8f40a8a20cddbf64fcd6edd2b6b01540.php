    ...
    <td colspan="7" class="k-s-content content" style="text-align: left;">
        ...
        <div style="float: right;">
            ...
            <div class="level_form" style="float: left;margin-left:10px;">
                ...
                <form action="<?php echo url('admin/ScholarshipHandle/MultipleGroupFill'); ?>" method="post" id="passingForm" class="passingForm">
                    <table class="w800">
                        <!-- <tr>
...
<?php if(!in_array($user['check_status'],[1])): ?>
<script>
