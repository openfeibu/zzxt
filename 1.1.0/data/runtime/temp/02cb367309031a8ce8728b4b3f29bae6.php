...
<div class="row">
    <div class="col-xs-12">
        <div>
            <form id="leftnav" class="ajaxForm4" name="leftnav" method="post" action="<?php echo url('admin/SetSubsidy/editAll'); ?>" >
                <!--<input type="hidden" name="checkk" id="checkk" value="1" />&lt;!&ndash;用于判断操作类型&ndash;&gt;-->
                <table class="table table-bordered table-hover" id="dynamic-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td height="28"><?php echo $v['id']; ?><input type="hidden" value="<?php echo $v['id']; ?>" name="id[]"></td>
                            <td><?php echo $v['subsidy_name']; ?></td>
                            <td><input type="text" value="<?php if($v['begin_time']): ?><?php echo date('Y-m-d',$v['begin_time']); endif; ?>" name="begin_time[]" data-provide="datepicker"></td>
                            <td><input type="text" value="<?php if($v['end_time']): ?><?php echo date('Y-m-d',$v['end_time']); endif; ?>" name="end_time[]" data-provide="datepicker"></td>
							<td><input type="text" value="<?php if($v['ypublic_begin_time']): ?><?php echo date('Y-m-d',$v['ypublic_begin_time']); endif; ?>" name="ypublic_begin_time[]" data-provide="datepicker"></td>
							<td><input type="text" value="<?php if($v['ypublic_end_time']): ?><?php echo date('Y-m-d',$v['ypublic_end_time']); endif; ?>" name="ypublic_end_time[]" data-provide="datepicker"></td>
							<td><input type="text" value="<?php if($v['xpublic_begin_time']): ?><?php echo date('Y-m-d',$v['xpublic_begin_time']); endif; ?>" name="xpublic_begin_time[]" data-provide="datepicker"></td>
							<td><input type="text" value="<?php if($v['xpublic_end_time']): ?><?php echo date('Y-m-d',$v['xpublic_end_time']); endif; ?>" name="xpublic_end_time[]" data-provide="datepicker"></td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        <tr>
							<td colspan="12" align="center">
								<button id="submit" type="submit" class="btn btn-purple">修改&nbsp;</button>
							</td>
						</tr>
                    </tbody>
                </table>
...
<script>
    ...
    {
        var id = obj.attr('tid');
        var begin_time = obj.closest('tr').find("input[name='begin_time']").val();
        var end_time = obj.closest('tr').find("input[name='end_time']").val();
//        console.log(begin_time)
        $.post("<?php echo url('/admin/set_subsidy/index'); ?>", {id:id,begin_time:begin_time,end_time:end_time});
    }
</script>
