...
<!-- /.nav-list -->
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="sys" method="post" action="<?php echo url('admin/Sys/runemail'); ?>">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 是否开启邮箱： </label>
						<div class="col-sm-9" style="padding-top:5px;">
							<input name="options[email_open]" id="email_open" <?php if($sys['email_open'] == 1): ?>checked<?php endif; ?>  value="1" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" />
							<span class="lbl"></span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="options[email_rename]" id="email_rename" value="<?php echo $sys['email_rename']; ?>"  class="col-xs-10 col-sm-5" required/>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="email" name="options[email_name]" id="email_name" value="<?php echo $sys['email_name']; ?>"  class="col-xs-10 col-sm-5" required/>
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="restwo"></span>
											</span>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="options[email_smtpname]" id="email_smtpname" value="<?php echo $sys['email_smtpname']; ?>"  class="col-xs-10 col-sm-5" required/>
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select name="options[smtpsecure]"  id="smtpsecure" class="col-xs-10 col-sm-5" >
								<option value="" <?php if($sys['smtpsecure'] == ''): ?>selected<?php endif; ?>>普通连接方式</option>
								<option value="ssl" <?php if($sys['smtpsecure'] == 'ssl'): ?>selected<?php endif; ?>>SSL连接方式</option>
								<option value="tls" <?php if($sys['smtpsecure'] == 'tls'): ?>selected<?php endif; ?>>TLS连接方式</option>
							</select>
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="number" name="options[smtp_port]" id="smtp_port" value="<?php echo (isset($sys['smtp_port']) && ($sys['smtp_port'] !== '')?$sys['smtp_port']:25); ?>"  class="col-xs-10 col-sm-5" required/>
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="options[email_emname]" id="email_emname" value="<?php echo $sys['email_emname']; ?>"  class="col-xs-10 col-sm-5" required/>
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" id="restwo"></span>
											</span>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="password" name="options[email_pwd]" id="email_pwd" value="<?php echo $sys['email_pwd']; ?>"  class="col-xs-10 col-sm-5" required/>
											<span class="help-inline col-xs-12 col-sm-7">
...
<script>
    $(document).ready(function(){
        $('#smtpsecure').change(function(){
            ...
            var $port=$type=='ssl'?465:25;//不同方式默认端口
            $('#smtp_port').val($port);
        })
    })
</script>
