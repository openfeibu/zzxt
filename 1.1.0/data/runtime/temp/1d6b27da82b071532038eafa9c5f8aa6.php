<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/\evaluation\material_front.html";i:1526656739;s:94:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/public\header\nav_membership_header.html";i:1524040517;s:72:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/public\footer.html";i:1515387963;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="main w1000" style="background:#fff;">
    ...
    <form class="personal_table upload_form" action="<?php echo url('show/material_post'); ?>" method="post" enctype="multipart/form-data" id="material_form">
        <table width="756px">
            <tbody>
            ...
            <tbody>
                ...
                <tr class="table-tr">
                    ...
                    <td class="title td_upfile">
                       <a href="<?php echo $user['member_list_headpic']; ?>" target="_blank"><img src="<?php echo $user['member_list_headpic']; ?>" width="100px;"/></a>
                    </td>
                </tr>
                ...
                <tr class="table-tr">
                    ...
                    <td class="title td_upfile">
                        <a href="<?php echo $v['images']; ?>" target="_blank"><img src="<?php echo $v['images']; ?>" width="100px;"/></a>
                    </td>
                </tr>
        ...
        <table class="table_one" style="word-wrap: break-word;word-break: break-all;">
            ...
            <tr class="table-tr">
                ...
                <td class="title td_upfile">
					...
					<input type="hidden" name="member_list_headpic_url" id="member_list_headpic_url" value="<?php echo $user['member_list_headpic']; ?>"/>
					
                </td>
                <td >
					<?php if($user['member_list_headpic']): ?>
					<img src="<?php echo $user['member_list_headpic']; ?>" width="100px;"/>
					<?php else: ?>
					<div class="upfile_name" id="member_list_headpic_image">文件名</div>
					<?php endif; ?>
				</td>
            </tr>
            <?php if(is_array($material_configs) || $material_configs instanceof \think\Collection || $material_configs instanceof \think\Paginator): if( count($material_configs)==0 ) : echo "" ;else: foreach($material_configs as $key=>$v): ?>
            <tr class="table-tr">
                <td><?php echo ++$m; ?></td>
                <td><?php echo $v['name']; ?></td>
                <td><?php echo $v['desc']; ?></td>
                ...
                <td class="title td_upfile">
                    <label class="file_ui">上传文件<input type="file"   name="image_<?php echo $v['cid']; ?>" id="image_<?php echo $v['cid']; ?>" class="upfile" ></label>
                    <!--<div class="upfile_name">文件名</div>-->
                    <input type="hidden" name="cids[]" id="cids" value="<?php echo $v['cid']; ?>"/>
					<input type="hidden" name="images[]" id="image_<?php echo $v['cid']; ?>_url" value=""/>
                </td>
                <td ><div class="upfile_name" id="image_<?php echo $v['cid']; ?>_image">文件名</div></td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
        </table>
...
$(".upfile").change(function(){
	...
	$.ajax({
		url: "<?php echo url('home/Show/material_upload'); ?>",
		type: "POST",
		data: formData,
		contentType: false,
		processData: false,
