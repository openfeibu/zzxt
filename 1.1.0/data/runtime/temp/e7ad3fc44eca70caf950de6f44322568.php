    ...
    <div class="page-header">
        <h1>
            ...
            <small>
                ...
                <a href="">国家<?php echo config('application_type.'.$type_id); ?>全院审核</a>
            </small>
            <!--<small>-->
            <!--<i class="ace-icon fa fa-angle-double-right"></i>-->
            <!--个人简历-->
        ...
        <div class="col-md-12 column">
            <div >
                ...
                <form class="tab_inquire" method="post">
                    ...
                    <div class="tab_search">
                        <a href="<?php echo url('admin/StudentOffice/applicantListExport',array('id' => $type_id)); ?>" title="导出">
                            导出：
    						<i class="fa fa-download export"></i>
    					</a>
                    </div>
                </form>
                <form class="ajaxForm" id="alldel" name="alldel" method="post" action="<?php echo url('admin/ScholarshipHandle/MultipleStudentOfficeFillAll'); ?>">
