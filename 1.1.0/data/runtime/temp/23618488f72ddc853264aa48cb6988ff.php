...
<table class="table table-bordered tab_center" id="evalu_form">
    ...
    <?php $num = 1; $__FOR_START_1826__=1;$__FOR_END_1826__=5;for($i=$__FOR_START_1826__;$i < $__FOR_END_1826__;$i+=1){ if($eval_app['members']['name'][$i-1]): $num++; endif; } ?>
    ...
    <?php $__FOR_START_31162__=1;$__FOR_END_31162__=5;for($i=$__FOR_START_31162__;$i < $__FOR_END_31162__;$i+=1){ if($eval_app['members']['name'][$i-1]): ?>
     <tr class="line-table-height">
...
<script>
 $("#evalu_form").find("input").attr('disabled',true);
  $("#evalu_form").find("select").attr('disabled',true);
                ...
                <form action="<?php echo url('admin/EvaluationHandle/evaluationGroup'); ?>" method="post" id="passingForm" class="passingForm">
                <table class="w800">
                    <tr >
...
<?php if(!in_array($user['evaluation_status'],[1,7])): ?>
<script>
