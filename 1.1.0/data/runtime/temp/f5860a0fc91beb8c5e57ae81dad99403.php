<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:70:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\\publicity\scholar.html";i:1523665787;s:63:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\base.html";i:1504198734;s:65:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\header.html";i:1515324146;s:67:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\left_nav.html";i:1514991728;s:67:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\head_nav.html";i:1514991728;s:70:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\publicity\yxselect.html";i:1523665748;s:68:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\publicity\select.html";i:1523665518;s:68:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\publicity\common.html";i:1523602834;s:65:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\footer.html";i:1515324146;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="page-content">
    <div class="page-header">
        <h1 style="display: inline-block;">
            您当前操作
            <small>
            <i class="ace-icon fa fa-angle-double-right"></i>国家奖学金公示结果
            </small>
        </h1>
    </div>
        ...
        <div class="col-md-12 column">
            <div>
                <table class="table_heading" style="width:100%">
                    <tr>
                        <td colspan="3" style="font-size: 25px;font-weight: 600;text-align: center;line-height: 48px;">
                            国家奖学金公示
                        </td>
                    </tr>
                </table>
				<form class="tab_inquire" method="post">
	<select class="form-control tab_select counselor_sub class_more" onchange="window.location=this.value;">
		<option value="?public_type=ypublic" <?php if($public_type == 'ypublic'): ?>selected<?php endif; ?>>院内公示</option>
		<option value="?public_type=xpublic" <?php if($public_type == 'xpublic'): ?>selected<?php endif; ?>>全校公示</option>
	</select>
</form>
                <?php if(!isset($list)): ?>
                公示时间为：<?php echo date('Y-n-d',$begin_time); ?> —— <?php echo date('Y-n-d',$end_time); else: ?>
				<form class="tab_inquire" method="post">
	...
	<?php endif; ?>
                ...
                <table class="table table-bordered table-hover tab_center table-striped">
                    <thead>
                    <th>姓名</th>
                    <th>身份证</th>
                    <th>班级</th>
