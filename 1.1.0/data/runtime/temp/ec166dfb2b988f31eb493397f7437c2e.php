...
<div class="page-content">
    <div class="page-header">
        <h1 style="display: inline-block;">
            您当前操作
            <small>
            <i class="ace-icon fa fa-angle-double-right"></i>国家励志奖学金院系公示结果
            </small>
        </h1>
    </div>
