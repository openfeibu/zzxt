                    ...
                    <table class="w800">
                        ...
                        <tr>
                            <td colspan="3" class="tab_content">
                                <?php if(!in_array($user['check_status'],[1,2])): ?>
