...
<div class="page-content">
    <div class="page-header">
        <h1>
            您当前操作
            <small>
                <i class="ace-icon fa fa-angle-double-right"></i>国家励志奖学金院系审核
            </small>
            <!--<small>-->
    ...
    <input type="hidden" name="faculty" value="5">
    ...
    <td>
        <div class="audit_opera">
            <div action="<?php echo url('admin/ScholarshipHandle/MultipleCounselorFill'); ?>" class="passingDiv2" method="post">
                ...
                <div class="audit_opera">
                    <button class="btn btn-primary btn-sm" type="submit" name="pass" <?php if(!in_array($row['check_status'],[1,2])): ?>disabled<?php endif; ?>>通过</button>
                </div>
                <!-- <div class="audit_opera"> -->
