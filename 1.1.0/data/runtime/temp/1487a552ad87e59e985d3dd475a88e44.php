<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/work_study\workStudyList.html";i:1504198734;s:94:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/public\header\nav_membership_header.html";i:1515387963;s:72:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/public\footer.html";i:1515387963;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<!--<div class="nav printHide">
    <ul class="w1000">
        ...
        <li><a href="<?php echo url('home/workstudy/resume'); ?>">个人信息</a></li>
        <li class=" active"><a href="<?php echo url('home/workstudy/list'); ?>">岗位申报</a></li>
    ...
    <div class="myexam">
        <table width="800" style="margin:0 auto;border-radio:5px;">
            <tr class="line-table-height" style="font-size:16px;background:#438EB9;color:#fff;line-height:35px">
                <td class="k-s-content title"  width="20%">岗位</td>
                <td class="k-s-content title">计划人数</td>
                <td class="k-s-content title">已报名人数</td>
                <td class="k-s-content title" >操作</td>
            </tr>
            <?php foreach($list as $row): ?>
            <tr class="line-table-height">
                <td class="k-s-content content"  width="40%"><?php echo $row['job_name']; ?></td>
                <td class="k-s-content content"><?php echo $row['number']; ?></td>
                <td class="k-s-content content"><?php echo $row['count']; ?></td>
                <td class="k-s-content content" ><a class="btn" href="<?php echo url('home/WorkStudy/applyJob',['id'=>$row['work_id']]); ?>">申请</a></td>
            </tr>
            <?php endforeach; ?>
        </table>
    </div>
