    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <div>
                ...
                <form class="tab_inquire" method="post" action="<?php echo url('admin/FacultyGroup/showEvaluationList'); ?>">
...
<td class="status">
    ...
    <td class="tab_content">
        ...
        <div class="audit_opera">
            <button class="btn btn-sm btn-primary" type="submit" name="pass" <?php if(!in_array($row['evaluation_status'],[3,9])): ?>disabled<?php endif; ?> >通过</button>
        </div>
        <!-- <div class="audit_opera"> -->
