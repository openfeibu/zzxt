<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:76:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\evaluation\manage_review.html";i:1523344005;s:63:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\base.html";i:1504198734;s:65:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\header.html";i:1515324146;s:67:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\left_nav.html";i:1514991728;s:67:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\head_nav.html";i:1514991728;s:73:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\common\evaluation_key.html";i:1513607663;s:81:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\evaluation\manage_ajax_review.html";i:1526648788;s:73:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\common\evaluation_val.html";i:1515025175;s:65:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\footer.html";i:1515324146;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <div>
                ...
                <form class="tab_inquire" method="post" action="<?php echo url('admin/StudentOffice/showEvaluationList'); ?>">
                    <select class="form-control tab_select counselor_sub ajax_change faculty_more" name="faculty_number" href="<?php echo url('admin/ClassCode/getClasses'); ?>">
                        <option value="0">所有系</option>
                        <?php foreach($faculties as $row): ?>
                        <option value="<?php echo $row['faculty_number']; ?>"><?php echo $row['faculty_name']; ?></option>
                        <?php endforeach; ?>
                    </select>
                    ...
                    <div class="tab_search">
                        <a href="<?php echo url('admin/StudentOffice/showEvaluationListExport'); ?>" title="导出">
                            导出：
    						<i class="fa fa-download export"></i>
    					</a>
                    </div>
                </form>
            	<form class="ajaxForm" id="alldel" name="alldel" method="post" action="<?php echo url('admin/EvaluationHandle/studentOfficeAll'); ?>">
...
<td class="status">
    ...
    <td class="tab_content">
        <div action="<?php echo url('admin/EvaluationHandle/studentOffice'); ?>" class="passingDiv" method="post">
        ...
        <!-- <div class="audit_opera"> -->
            <!-- <button class="btn btn-info btn-sm btn-success" type="submit" name="pass" <?php if($row['status'] != 4): ?>disabled<?php endif; ?>>通过</button> -->
        <!-- </div> -->
        <div class="audit_opera">
            <button class="btn btn-info btn-sm btn-danger" type="submit" name="fail" <?php if($row['status'] == 9): ?>disabled<?php endif; ?> value="1">不通过</button>
        </div>
...
<tr>
    <td align="left" class="hidden-xs center">
        <!-- <button id="passSubmit2" class="btn btn-purple btn-sm hidden-xs" name="pass">通过&nbsp;</button> -->
        <button id="failSubmit2" class="btn btn-danger  btn-sm hidden-xs" name="fail">不通过</button>
    </td>
...
<script type="text/javascript">
	$('body').on('click','#passSubmit2',function(){
		url = "<?php echo url('admin/EvaluationHandle/studentOfficeAll'); ?>";
		$(".ajaxForm").attr('action',url);
		return true;
	});
    $('body').on('click','#failSubmit2',function(){
		url = "<?php echo url('admin/EvaluationHandle/studentOfficeAll',array('fail'=>1)); ?>";
		$(".ajaxForm").attr('action',url);
		return true;
	});
</script>
