    ...
    <div class="page-header">
        <h1>
            ...
            <small>
                ...
                <i class="ace-icon fa fa-angle-double-right"></i><?php echo $news_title; ?>
            </small>
        </h1>
    </div>
    <div class="clearfix">
        <div class="col-md-12">
            <div class="w1000">
                <h3 class="text-center"><?php echo $news_title; ?></h3>
                <p class="text-center">发布时间：<?php echo date("Y-m-d H:i:s",$news_time); ?></p>
                <br>
                <br>
