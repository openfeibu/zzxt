...
<table class="table table-bordered tab_center" id="evalu_form">
    ...
    <?php $num = 1; $__FOR_START_4200__=1;$__FOR_END_4200__=5;for($i=$__FOR_START_4200__;$i < $__FOR_END_4200__;$i+=1){ if($eval_app['members']['name'][$i-1]): $num++; endif; } ?>
    ...
    <?php $__FOR_START_13748__=1;$__FOR_END_13748__=5;for($i=$__FOR_START_13748__;$i < $__FOR_END_13748__;$i+=1){ if($eval_app['members']['name'][$i-1]): ?>
     <tr class="line-table-height">
                ...
                <tr>
                    ...
                    <tr>
                        <td colspan="11" class="tab_content disabled">
                            ...
                            <div class="tab_time">
                                <input type="text" value="<?php echo date('Y',$user['group_opinion']['time']); ?>">年
                                <input type="text" value="<?php echo date('n',$user['group_opinion']['time']); ?>">月
                                <input type="text" value="<?php echo date('d',$user['group_opinion']['time']); ?>">日
                            </div>
                        </td>
                    </tr>
                    <?php endif; if($user['faculty_opinion']): ?>
                    <tr>
                        <td colspan="11" class="tab_content disabled">
                            <p class="tab_left">院系评定小组意见</p>
                            <textarea class="tab_opinion" disabled><?php echo $user['faculty_opinion']['text']; ?></textarea>
                            <div class="tab_time">
                                <input type="text" value="<?php echo date('Y',$user['faculty_opinion']['time']); ?>">年
                                <input type="text" value="<?php echo date('n',$user['faculty_opinion']['time']); ?>">月
                                <input type="text" value="<?php echo date('d',$user['faculty_opinion']['time']); ?>">日
                            </div>
                        </td>
                    </tr>
                    <?php endif; ?>
                </table>
                <form action="<?php echo url('admin/EvaluationHandle/studentOffice'); ?>" method="post" id="passingForm" class="passingForm">
                <table class="w800">
                    <tr>
...
<?php if($user['evaluation_status'] == 9): ?>
<script>
