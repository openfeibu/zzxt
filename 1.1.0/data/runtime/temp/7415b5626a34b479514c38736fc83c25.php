...
<link rel="stylesheet" href="__PUBLIC__/autocompleter/main.css" />
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal adminform" name="admin_list_add" method="post" action="<?php echo url('admin/Admin/counselor_admin_runadd'); ?>">
		...
		(function(){  
			$("#admin_username").autocomplete({
				...
				source:function(request ,response){
					$.ajax({
						url : "<?php echo url('admin/ajax/getStudents'); ?>",
						type : "post",
						dataType : "json",
			...
			$('#admin_username').keyup(function(){  
				...
				if(value.length>0)
				{
					var url = "<?php echo url('admin/ajax/getStudents'); ?>";  
