<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/scholarship\scho_grants.html";i:1524043029;s:94:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/public\header\nav_membership_header.html";i:1524040517;s:72:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/public\footer.html";i:1515387963;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="main w1000" style="background:#fff;">
    ...
    <form action="" method="post" enctype="multipart/form-data" id="schoForm">
            ...
            <table width="756px" class="k-w-table line_table">
                <tbody>
                    <tr class="line-table-height gants_tab">
                        ...
                        <td colspan="1" class="k-s-content" rowspan="4" style="text-align: center;position:relative;width:125px; ">
                    ...
                    <tr class="line-table-height">
                        ...
                        <td colspan="1" class="k-s-content content"><input type="text" name="income_source" value="<?php if(isset($list['income_source'])): ?><?php echo $list['income_source']; endif; ?>"/></td>
                    </tr>
                    <tr class="line-table-height">
                            ...
                            <div style="float: right;">
                                ...
                                <div class="level_form">
                                    <div class="level_time">
                                        <input type="text" value="<?php echo date('Y',$list['time']); ?>" disabled>
                                        <label for="">年</label>
                                    </div>
                                    <div class="level_time">
                                        <input type="text" value="<?php echo date('m',$list['time']); ?>" disabled>
                                        <label for="">月</label>
                                    </div>
                                    <div class="level_time">
                                        <input type="text" value="<?php echo date('d',$list['time']); ?>" disabled>
                                        <label for="">日</label>
                                    </div>
                                </div>
                            </div>
        ...
        <?php endif; ?>
        <button class="print printHide" onclick="preview(2)">打印</button>
        <?php else: ?>
        <div>
            <p style="color:red;font-size:18px;text-align:center;">抱歉，通过家庭困难认定后才能申请</p>
        </div>
        <?php endif; ?>
    </form>
</div>
<script>
$("#schosubmit").click(function(){
});
</script>
<?php if($is_data): ?>
<script>
$("#schoForm").find("input").attr('disabled',true);
$("#schoForm").find("select").attr('disabled',true);
$("#schoForm").find("textarea").attr('disabled',true);
</script>
<?php endif; ?>
