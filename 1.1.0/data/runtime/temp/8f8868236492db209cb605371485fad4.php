    ...
    <div class="page-header">
        <h1>
            ...
            <small>
                ...
                <a href="">国家<?php echo config('application_type.'.$type_id); ?>辅导员审核</a>
            </small>
            <small>
            <i class="ace-icon fa fa-angle-double-right"></i>
            添加推荐理由
    ...
    <td colspan="7" class="k-s-content content" style="text-align: left;">
        ...
        <div style="float: right;">
            ...
            <div class="level_form" style="float: left;margin-left:10px;">
                ...
                <form action="<?php echo url('admin/ScholarshipHandle/MultipleCounselorFill'); ?>" method="post" id="passingForm" class="passingForm">
                    <table class="w800">
                        <tr>
                            <td class="tab_title"><p class=" tab_left" style="font-size: 16px;">填写推荐理由（100字）：</p></td>
                            <td colspan="2"></td>
                        </tr>
                        <tr>
...
<?php if(!in_array($user['check_status'],[2])): ?>
<script>
