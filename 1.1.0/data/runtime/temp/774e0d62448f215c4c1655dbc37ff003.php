<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:83:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\faculty_group\showApplicantList.html";i:1523316606;s:63:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\base.html";i:1504198734;s:65:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\header.html";i:1515324146;s:67:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\left_nav.html";i:1514991728;s:67:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\head_nav.html";i:1514991728;s:80:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\common\group_application_key.html";i:1513607663;s:90:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\faculty_group\ajax_showApplicationList.html";i:1526634078;s:80:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\common\group_application_val.html";i:1513607663;s:65:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\footer.html";i:1515324146;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="page-header">
        <h1>
            ...
            <small>
                ...
                <a href="">国家<?php echo config('application_type.'.$type_id); ?>院系审核</a>
            </small>
            <!--<small>-->
            <!--<i class="ace-icon fa fa-angle-double-right"></i>-->
            <!--个人简历-->
            ...
            <div>
                ...
                <form class="tab_inquire" method="post">
                    ...
                    <select class="form-control tab_select class_select ajax_change" name="status">
                        ...
                        <?php foreach(\think\Config::get('check_status') as $k => $v): ?>
...
<tr>
    <td>
        <?php if(!in_array($row['check_status'],[3])): ?>
...
<td>
    ...
    <td class="tab_content">
        ...
        <div class="audit_opera">
            <button class="btn btn-sm btn-primary" type="submit" name="pass" <?php if($row['check_status'] != 3): ?>disabled<?php endif; ?>>通过</button>
        </div>
        <!-- <div class="audit_opera"> -->
            <!-- <button class="btn btn-info btn-sm btn-danger" type="submit" name="fail" <?php if($row['check_status'] != 3): ?>disabled<?php endif; ?> value="1">不通过</button> -->
        <!-- </div> -->
        <?php else: ?>
        <div class="audit_opera">
            <button class="btn btn-sm btn-primary" type="submit" name="pass" <?php if($row['check_status'] != 2): ?>disabled<?php endif; ?>>通过</button>
        </div>
        <!-- <div class="audit_opera"> -->
            <!-- <button class="btn btn-info btn-sm btn-danger" type="submit" name="fail" <?php if($row['check_status'] != 2): ?>disabled<?php endif; ?> value="1">不通过</button> -->
        <!-- </div> -->
        <?php endif; ?>
        <div class="audit_opera">
...
<?php endforeach; ?>  
<tr>
    <td align="left" class="hidden-xs center" href="<?php echo url('admin/ScholarshipHandle/MultipleFacultyAllFill'); ?>">
        <button id="passSubmit" class="btn btn-primary btn-sm hidden-xs" name="pass">通过&nbsp;</button>
