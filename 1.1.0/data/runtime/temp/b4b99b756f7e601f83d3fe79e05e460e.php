<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:95:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/student_personal_front\questionnaire.html";i:1524040760;s:94:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/public\header\nav_membership_header.html";i:1524040517;s:72:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/public\footer.html";i:1515387963;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="ques_main" method="post">
        ...
        <div class="ques_info">
            <div class="bottom_input ques_input">
                <label >年级</label>
                <input type="text" value="<?php echo $user['grade']; ?>" name="grade">
            </div>
            <div class="bottom_input ques_input">
                <label >专业</label>
                <input type="text" value="<?php echo $user['profession']; ?>" name="profession">
            </div>
            <div class="bottom_input ques_input">
                <label >性别</label>
                <input type="text" value="<?php echo $user['gender']; ?>" name="gender">
            </div>
        </div>
