...
<!-- /.nav-list -->
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="sys" method="post" action="<?php echo url('admin/Sys/runactive'); ?>">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 是否开启邮箱激活： </label>
						<div class="col-sm-9" style="padding-top:5px;">
							<input name="options[email_active]" id="email_open" <?php if(!empty($sys['email_active'])): ?>checked<?php endif; ?>  value="1" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" />
							<span class="lbl"></span>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 邮件标题： </label>
						<div class="col-sm-9">
							<input type="text" name="options[email_title]" id="email_title" value="<?php echo $sys['email_title']; ?>"  class="col-xs-10 col-sm-7" required/>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							...
							<textarea name="options[email_tpl]" rows="100%" style="width:100%" id="myEditor"><?php echo $sys['email_tpl']; ?></textarea>
							<script type="text/javascript">
								var editor = new UE.ui.Editor();
								editor.render("myEditor");
							</script>
							<span style="color: #F3920A;">请用http://#link#代替激活链接，#username#代替用户名</span>
						</div>
					</div>
					<div class="space-4"></div>
