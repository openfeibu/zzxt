<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/user\active.html";i:1524043005;s:94:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/public\header\nav_membership_header.html";i:1524040517;s:72:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/home/view/default/public\footer.html";i:1515387963;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="main w1000" style="background:#fff;">
    ...
    <div class="row">
        <div class="col-xs-10 col-xs-offset-1">
            <div id="main-cmf">
				<div class="content" >
					<form class="form-inline ajax-form" action="<?php echo url('home/Login/resend'); ?>">
					  <div class="form-group">
						<label class="" for="email">邮箱：</label>
						<input type="email" name="email" class="form-control" id="email" placeholder="Email" value="<?php echo $user['member_list_email']; ?>">
					  </div>
