...
<!-- /.nav-list -->
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="admin_group_add" method="post" action="<?php echo url('admin/Admin/admin_group_runadd'); ?>">
