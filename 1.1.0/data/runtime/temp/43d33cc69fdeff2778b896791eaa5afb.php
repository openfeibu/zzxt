...
<div class="page-content">
    <div class="page-header">
        <h1>
            您当前操作
            <small>
                <i class="ace-icon fa fa-angle-double-right"></i>学生家庭经济困难认定评分线
            </small>
        </h1>
    </div>
        ...
        <div class="col-md-12 column">
                <div class="col-xs-12">
                    <table  id="simple-table"  class="table table-striped table-bordered table-hover tab_center">
                        ...
                        <tbody>
                        <?php foreach($grade_configs as $key => $val): ?>
                        <tr>
                            <td><?php echo $val['id']; ?></td>
                            <td><?php echo $val['name']; ?></td>
                            <td data-id="<?php echo $val['id']; ?>" data-attr="min">
                                <input name="min" attr="" value="<?php echo $val['min']; ?>" class="grade score_input">
                            </td>
                            <td data-id="<?php echo $val['id']; ?>" data-attr="max">
                                <input name="max" attr="" value="<?php echo $val['max']; ?>" class="grade score_input">
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        </tbody>
