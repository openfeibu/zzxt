...
<table class="table table-bordered tab_center" id="evalu_form">
    ...
    <?php $num = 1; $__FOR_START_17584__=1;$__FOR_END_17584__=5;for($i=$__FOR_START_17584__;$i < $__FOR_END_17584__;$i+=1){ if($eval_app['members']['name'][$i-1]): $num++; endif; } ?>
    ...
    <?php $__FOR_START_6272__=1;$__FOR_END_6272__=5;for($i=$__FOR_START_6272__;$i < $__FOR_END_6272__;$i+=1){ if($eval_app['members']['name'][$i-1]): ?>
     <tr class="line-table-height">
 ...
 $("#evalu_form").find("input").attr('disabled',true);
  $("#evalu_form").find("select").attr('disabled',true);
                ...
                <button type="button" class="btn btn-info" onclick="preview(3)">打印</button>
                    <form action="<?php echo url('admin/EvaluationHandle/counselor'); ?>" method="post" id="passingForm" class="passingForm">
                    <table class="w800">
                        <tr >
                        ...
                        <tr>
                            <td colspan="3" class="tab_content">
                                <?php if(!in_array($user['evaluation_status'],[1,2])): ?>
                        ...
                        <tr>
							...
							<td class="tab_content" style="width: 500px;">
								...
								<button type="submit" class="btn btn-sm btn-primary" name="pass" value="<?php echo $status_id; ?>">通过</button>
								<!-- <button type="submit" class="btn btn-danger" name="fail" value="<?php echo $status_id; ?>">不通过</button> -->
								<!-- <a href="<?php echo url('admin/Counselor/evaluationNext',['id'=>$status_id]); ?>" class="btn btn-success">下一个</a> -->
							</td>
