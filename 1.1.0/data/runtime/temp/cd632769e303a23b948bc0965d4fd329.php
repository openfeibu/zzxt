<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:66:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\news\news_back.html";i:1504198734;s:63:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\base.html";i:1504198734;s:65:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\header.html";i:1515324146;s:67:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\left_nav.html";i:1514991728;s:67:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\head_nav.html";i:1514991728;s:71:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\news\ajax_news_back.html";i:1504198734;s:65:"D:\UPUPW_K2.1\htdocs\zzxt\1.0.0/app/admin\view\public\footer.html";i:1515324146;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!-- /.nav-list -->
	...
	<div class="page-content">
		...
		<form name="admin_list_sea" class="form-search form-horizontal" id="list-filter" method="post" action="<?php echo url('admin/News/news_back'); ?>">
	...
	<tr>
		...
		<td>
			<div class="action-buttons">
				<a class="red confirm-rst-url-btn" data-info="你确定要还原文章到文章列表吗？" href="<?php echo url('admin/News/news_back_open',array('n_id'=>$v['n_id'],'p'=>input('p',1))); ?>" title="还原">
					<i class="ace-icon fa fa-check bigger-130"></i>																</a>
				<a class="red confirm-rst-url-btn" data-info="你确定要彻底删除文章吗？" href="<?php echo url('admin/News/news_back_del',array('n_id'=>$v['n_id'],'p'=>input('p',1))); ?>" title="删除">
			...
			<div class="hidden-md hidden-lg hidden-sm hidden-xs">
				<div class="inline position-relative">
					...
					<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
						<li>
							<a href="<?php echo url('admin/News/news_back_open',array('n_id'=>$v['n_id'],'p'=>input('p',1))); ?>" class="tooltip-success confirm-rst-url-btn" data-info="你确定要还原文章到文章列表吗？" data-rel="tooltip" title="" data-original-title="还原">
											<span class="green">
						...
						<li>
							<a href="<?php echo url('admin/News/news_back_del',array('n_id'=>$v['n_id'],'p'=>input('p',1))); ?>"  class="tooltip-error confirm-rst-url-btn" data-info="你确定要彻底删除文章吗？" data-rel="tooltip" title="" data-original-title="删除">
											<span class="red">
