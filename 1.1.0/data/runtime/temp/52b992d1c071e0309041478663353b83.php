...
<div class="page-content">
    <div class="page-header">
        <h1>
            您当前操作
            <small>
                <i class="ace-icon fa fa-angle-double-right"></i>查看系统公告
            </small>
        </h1>
    </div>
    <div class="clearfix">
        <div class="col-md-12">
            <div class=" notice_list ">
                <ul >
                    ...
                    <li><a href="<?php echo url('admin/Notice/index',array('id'=>$vo['n_id'])); ?>"><p><?php echo $vo['news_title']; ?></p><span><?php echo date("Y-m-d",$vo['news_time']); ?></span></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    <!--<li><a href="<?php echo url('admin/GrantsFront/G_class_notice'); ?>"><p>2017年国家助学金院系公示结果</p><span>2017-09-05</span></a></li>-->
                    <!--<li><a href="<?php echo url('admin/GrantsFront/G_manage_notice'); ?>"><p>2017年国家助学金学院公示结果</p><span>2017-09-05</span></a></li>-->
                    <!--<li><a href="<?php echo url('admin/MotivFront/M_faculty_notice'); ?>"><p>2017年国家励志院系奖学金公示结果</p><span>2017-09-05</span></a></li>-->
                    <!--<li><a href="<?php echo url('admin/MotivFront/M_manage_notice'); ?>"><p>2017年国家励志学院奖学金公示结果</p><span>2017-09-05</span></a></li>-->
                    <!--<li><a href="<?php echo url('admin/ScholarFront/S_faculty_notice'); ?>"><p>2017年国家奖学金院系公示结果</p><span>2017-09-05</span></a></li>-->
                    <!--<li><a href="<?php echo url('admin/ScholarFront/S_manage_notice'); ?>"><p>2017年国家奖学金学院公示结果</p><span>2017-09-05</span></a></li>-->
                    <!--<li><a href="<?php echo url('admin/EvaluFront/E_faculty_notice'); ?>"><p>2017年家庭经济情况困难认定院系公示结果</p><span>2017-09-05</span></a></li>-->
                    <!--<li><a href="<?php echo url('admin/MotivFront/M_sys_notice_det'); ?>"><p>2017年家庭经济情况困难认定学院公示结果</p><span>2017-09-05</span></a></li>-->
                </ul>
            </div>
        </div>
    </div>
