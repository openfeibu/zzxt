...
<!-- /.nav-list -->
	...
	<tr>
		...
		<td><a href="<?php echo url('admin/News/news_edit',array('n_id'=>$v['n_id'])); ?>" title="<?php echo $v['news_title']; ?>"><?php echo subtext($v['news_title'],25); ?></a></td>
