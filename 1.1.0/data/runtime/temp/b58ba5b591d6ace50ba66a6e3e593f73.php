...
<div class="page-content">
    <div class="page-header">
        <h1 style="display: inline-block;">
            您当前操作
            <small>
            <i class="ace-icon fa fa-angle-double-right"></i>查看国家助学金公示结果
            </small>
        </h1>
    </div>
