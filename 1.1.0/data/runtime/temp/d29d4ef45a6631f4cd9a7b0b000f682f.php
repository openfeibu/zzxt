...
<!-- /.nav-list -->
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal adminform" name="admin_list_edit" method="post" action="<?php echo url('admin/Admin/faculty_admin_runedit'); ?>">
						...
						<div class="col-sm-10">
							<select name="group_id"  class="col-sm-5" required>
								...
								<?php if(is_array($auth_group) || $auth_group instanceof \think\Collection || $auth_group instanceof \think\Paginator): if( count($auth_group)==0 ) : echo "" ;else: foreach($auth_group as $key=>$v): ?>
									<option value="<?php echo $v['id']; ?>" <?php if($v['id'] == $auth_group_access): ?>selected<?php endif; ?>><?php echo $v['title']; ?></option>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="admin_pwd" id="admin_pwd" maxlength="15" minlength="6" placeholder="输入登录密码,为空不更改" class="col-xs-10 col-sm-5" />
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<label>	<input type="checkbox" name="class_number[]" value="<?php echo $row['class_number']; ?>"  <?php if(in_array($row['class_number'],$class_numbers)): ?>checked<?php endif; ?>> <?php echo $row['current_grade']; ?><?php echo $row['class_name']; ?> </label>
							<?php endforeach; ?>
						</div>
					</div>
					<div class="space-4"></div>
