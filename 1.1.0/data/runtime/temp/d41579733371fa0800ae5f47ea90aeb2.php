					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="faculty_number" id="">
								<option value=""></option>
								<?php foreach($faculty_number as $row): ?>
								<option value="<?php echo $row['faculty_number']; ?>"<?php if($admin_list['faculty_number'] == $row['faculty_number']): ?>selected<?php endif; ?>><?php echo $row['faculty_name']; ?></option>
								<?php endforeach; ?>
							</select>
