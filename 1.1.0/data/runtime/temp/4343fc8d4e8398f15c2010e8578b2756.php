    ...
    <div class="page-header">
        <h1>
            ...
            <small>
                ...
                <a href="<?php echo url('admin/scholarships_group/showreviewlist'); ?>">国家<?php echo config('application_type.'.$type_id); ?>全院审核</a>
            </small>
            <small>
                <i class="ace-icon fa fa-angle-double-right"></i>
                添加评语
    ...
    <td colspan="7" class="k-s-content content" style="text-align: left;">
        ...
        <div style="float: right;">
            ...
            <div class="level_form" style="float: left;margin-left:10px;">
                ...
                <form action="<?php echo url('admin/ScholarshipHandle/MultipleStudentOfficeFill'); ?>" method="post" id="passingForm" class="passingForm">
                    <table class="w800">
                        <!-- <tr>
                            <td class="tab_title"><p class=" tab_left" style="font-size: 16px;">资助管理添加评语：</p></td>
                            <td colspan="2"></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="tab_content">
                                <textarea name="schoole_opinion[text]" id="" class="tab_opinion"><?php echo $user['schoole_opinion']['text']; ?></textarea>
                                <div class="tab_sign">
                                    <label for="">资助管理负责人签名：</label>
                                    <input type="text" name="schoole_opinion[name]" value="<?php echo $user['schoole_opinion']['name']; ?>">
                                </div>
                                <div class="clearfix"></div>
                                <div class="tab_time">
                                    <input type="text" name="schoole_opinion[year]" value="<?php echo date('Y',$user['schoole_opinion']['time']); ?>">年
                                    <input type="text" name="schoole_opinion[month]" value="<?php echo date('n',$user['schoole_opinion']['time']); ?>">月
                                    <input type="text" name="schoole_opinion[day]" value="<?php echo date('d',$user['schoole_opinion']['time']); ?>">日
                                </div>
                            </td>
                        </tr> -->
                        <tr>
...
<?php if(in_array($user['check_status'],[9])): ?>
<script>
