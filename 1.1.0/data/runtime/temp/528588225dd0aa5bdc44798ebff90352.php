	...
	<div class="page-content">
		...
		<div class="row maintop">
			<div class="col-xs-4 col-sm-2 margintop5">
				<a href="<?php echo url('admin/Admin/counselor_admin_add'); ?>">
			...
			<div class="col-xs-10 col-sm-5 margintop5">
				<form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('admin/Admin/counselor_admin_list'); ?>">
			...
			<div class="col-xs-4 col-sm-5 margintop5">
				<div class="input-group-btn">
					<a href="<?php echo url('admin/Admin/counselor_admin_list'); ?>">
								...
								<tr>
									...
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a class="green" href="<?php echo url('admin/Admin/counselor_admin_edit',array('admin_id'=>$v['admin_id'])); ?>" title="修改">
										...
										<div class="hidden-md hidden-lg">
											<div class="inline position-relative">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													<li>
														<a href="<?php echo url('admin/Admin/counselor_admin_edit',array('admin_id'=>$v['admin_id'])); ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
																	<span class="green">
