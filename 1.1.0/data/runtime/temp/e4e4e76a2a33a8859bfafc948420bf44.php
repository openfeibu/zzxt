...
<!-- /.nav-list -->
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal adminform" name="admin_list_edit" method="post" action="<?php echo url('admin/Admin/counselor_admin_runedit'); ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span>密码默认身份证后六位</span>
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="class_number" id="">
								...
								<option value="<?php echo $row['class_number']; ?>" <?php if($row['class_number'] == $admin_list['class_number']): ?>selected<?php endif; ?>><?php echo $row['current_grade']; ?><?php echo $row['class_name']; ?></option>
								<?php endforeach; ?>
							</select>
